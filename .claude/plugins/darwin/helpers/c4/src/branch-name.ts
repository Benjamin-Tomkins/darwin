 ...
 */
export function branchName(identifierChain: string[], asset?: string): string {
  if (identifierChain.length === 0) throw new Error('identifierChain must not be empty');
...
function parseIdentifierChain(raw: string): string[] {
